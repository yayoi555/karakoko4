...
class HealthManagementSystem {
    ...
    setupEventListeners() {
        ...
        // 期間フィルター
        document.getElementById('filterToday').addEventListener('click', () => this.setDateFilter('today'));
        document.getElementById('filterWeek').addEventListener('click', () => this.setDateFilter('week'));
        document.getElementById('filterMonth').addEventListener('click', () => this.setDateFilter('month'));
        document.getElementById('filterAll').addEventListener('click', () => this.setDateFilter('all'));
