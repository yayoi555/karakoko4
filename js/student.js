...
class StudentHealthCheck {
    ...
    setupEventListeners() {
        ...
        if (gradeSelect) gradeSelect.addEventListener('change', () => this.updateClassSelect());
        if (classSelect) classSelect.addEventListener('change', () => this.updateStudentSelect());
        if (studentSelect) studentSelect.addEventListener('change', () => this.updateLoginButton());
        ...
        const studentHealthForm = document.getElementById('studentHealthForm');
        
        if (logoutBtn) logoutBtn.addEventListener('click', () => this.handleLogout());
        if (prevBtn) prevBtn.addEventListener('click', () => this.previousStep());
        if (nextBtn) nextBtn.addEventListener('click', () => this.nextStep());
        if (studentHealthForm) studentHealthForm.addEventListener('submit', (e) => this.handleSubmit(e));
